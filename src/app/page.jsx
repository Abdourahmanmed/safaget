...
const Home = () => {
  ...
  return (
    <section >
      <Navbar isVisible={isNavbarVisible} Accueil={page} />
      <div className="accueil-img">
        <div className="position-absolute end-50 text-white ps-5 pt-5" id="accueil">
          <h2 className="text-white fw-bolder mb-4">Explorez l'Art de <br /> l'Impression Numérique</h2>
      ...
      <div className="container-fluid flex-column p-5 bg-orange">
        <div className="row text-center">
          ...
          <p className="text-center">
            Chez Safa Jet, notre engagement envers l'innovation et la qualité se reflète dans chacun <br />
            de nos services d'impression numérique.Nous sommes fiers d'offrir une gamme complète <br /> de
            solutions pour répondre à vos besoins créatifs et commerciaux. Explorez notre <br />
        ...
        <div className="row mt-5 gap-1">
          <div className="col-md-6 mx-auto">
            ...
            <h2>La réponse à vos besoins <br /> d'impression numérique</h2>
            <p>
              Chez Safa Jet, nous croyons en la puissance de la créativité et de l'innovation pour transformer vos idées en œuvres visuelles exceptionnelles. En tant que leader dans le domaine de l'impression numérique, nous nous engageons à offrir bien plus que des services d'impression standard.
            </p>
      ...
      <div className="accT">
        ...
        <div className="d-flex accTem-1 ">
          ...
          />
          <div className="p-4">
            <h4 className="fs-5 pb-3 text-white text">"Une Équipe Exceptionnelle"</h4>
            ...
            <h4 className="fs-5 pb-3 text-white text">"Créativité Sans Limite"</h4>
            <p className="fs-p text-white text">
            ...
            <h4 className="fs-5 pb-3 text-white text">"Qualité Inégalée"</h4>
            <p className="fs-p text-white text">
            ...
            <h4 className="fs-5 pb-3 text-white text">"Réactivité et Professionnalisme"</h4>
            <p className="fs-p text-white text">
      ...
      <div className="acc-realiser">
        <h4 className="fs-4 mx-5 mb-3 text-orange">
          Nos Réalisations
        </h4>
        ...
        <p className="fs-p mx-5 mb-5">
          Découvrez notre expertise à travers une collection captivante de projets réalisés avec passion et précision. <br /> Notre portfolio est le reflet de notre engagement envers
          l'excellence, illustrant comment Safa Jet transforme <br /> les concepts créatifs en impressions numériques exceptionnelles.
        </p>
        <div class="content">
      ...
      <div className="vh-100">
        <div className="part-partenaire pt-4 pb-5">
          ...
          <div className="container partenaire2">
            <div className="w-100 d-flex justify-content-between align-item-center flex-wrap">
              <Image
                src="/logo1.png"
                width={180}
                height={90}
            ...
            <div className="mt-3 w-100 d-flex justify-content-between align-item-center flex-wrap">
              <Image
                src="/logo5.png "
                width={180}
                height={90}
      ...
      <div className="container-fluid" id="acc-conc">
        <div className="row">
          <div className="col-md-6 col-lg-4 mb-4">
            <div className="acc-conc">
              <h3 className="fs-2 mb-4 text-orange">Contactez-nous</h3>
              <p>
                Que ce soit pour discuter de vos besoins d'impression numérique, obtenir des informations supplémentaires sur nos services, ou pour toute autre demande, l'équipe de Safa Jet est à votre disposition. N'hésitez pas à nous contacter selon vos préférences :
              </p>
              <div>
                <div className="d-flex align-items-center mb-2">
                  <Image src="/icon0.png" width={40} height={40} className="me-2 mb-0" />
                  <span>Centre-Ville, Rue de Berne, Djibouti</span>
                </div>
                <div className="d-flex align-items-center mb-3">
                  <Image src="/icon9.png" width={25} height={25} className="me-3" />
                  <span>+253 77 86 11 43 / +253 77 22 63 43</span>
                </div>
                <div className="d-flex align-items-center">
                  <Image src="/icon8.png" width={25} height={25} className="me-3" />
            ...
            <div className="acc-conc1">
              <form className="shadow-lg p-3 bg-body-tertiary rounded" id="formcom">
                ...
                <div className="row mb-4">
                  ...
                  <div className="col">
                    <div className="form-outline border-primary-subtle">
                      <input type="text" id="form6Example2" className="form-control" placeholder="Prénom" />
                    </div>
                  </div>
                </div>
                <div className="row mb-4">
                  <div className="col">
                    <div className="form-outline border-primary-subtle">
                      <input type="text" id="form6Example3" className="form-control" placeholder="Téléphone" />
                    </div>
                  </div>
                  <div className="col">
                    <div className="form-outline border-primary-subtle">
                      <input type="email" id="form6Example4" className="form-control" placeholder="Adresse email" />
                    </div>
                  </div>
                </div>
                ...
                <button type="button" className="btn btn-orange rounded">Envoyer</button>
              </form>
            </div>
          </div>
        </div>
