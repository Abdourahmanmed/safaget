  ...
  return (
    <section>
      ...
      <section className="container">
        ...
        <form className="shadow-lg p-3 bg-body-tertiary rounded mb-50 " id="formcom">
          ...
          <button data-mdb-ripple-init type="button" class="btn btn-orange mb-4 rounded">Envoyer</button>
        </form>
